...
class CommentaireController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('MediaBundle:commentaire:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('MediaBundle:commentaire:new.html.twig', array(
    ...
    public function showAction(Commentaire $commentaire)
    {
        ...
        return $this->render('MediaBundle:commentaire:show.html.twig', array(
            'commentaire' => $commentaire,
    ...
    public function editAction(Request $request, Commentaire $commentaire)
    {
        ...
        return $this->render('MediaBundle:commentaire:edit.html.twig', array(
            'commentaire' => $commentaire,
